    ...
    if (this.state.selectedBreed) {
      return (
        <div>
          ...
          <div className="DogBreeds__info-property">
            <span className="DogBreeds__info-key">Tolerates Being Alone: </span>
          ...
          <div className="DogBreeds__info-property">
            <span className="DogBreeds__info-key">Tolerates Hot Weather: </span>
            {this.state.selectedBreed["Tolerates Hot Weather"]}
          </div>
          <div className="DogBreeds__info-property">
            <span className="DogBreeds__info-key">Wanderlust Potential: </span>
